...
function Dashboard() {
  ...
  return (
    <div className="grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen">
      <Sidebar />
      <main className="lg:col-span-3 xl:col-span-5 bg-gray-300 p-8 h-[100vh] overflow-y-scroll">
        <Header />
        {/* Section 1 */}
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mt-10 gap-8">
          {/* Card 1 */}
          <div className="bg-[#111111] p-8 rounded-xl text-gray-300 flex flex-col gap-6">
            <RiLineChartLine className="text-5xl" />
            <h4 className="text-2xl">Earnings</h4>
            <span className="text-5xl text-white">&euro; 8,350</span>
            <span className="py-1 px-3 bg-gray-700 rounded-full">
              + 10% since last month
            </span>
          </div>
          {/* Card 2 */}
          <div className="p-4 bg-white rounded-xl flex flex-col justify-between gap-4 drop-shadow-2xl">
            <div className="flex items-center gap-4 bg-gray-200 rounded-xl p-4">
              <span className="bg-[#111111] text-gray-200 text-2xl font-bold p-4 rounded-xl">
                98
              </span>
              <div>
            ...
            <div className="bg-gray-200 rounded-xl p-4">
              <div className="flex items-center gap-4 mb-4">
                <span className="bg-[#111111] text-gray-300 text-2xl font-bold p-4 rounded-xl">
                  32
                </span>
                <div>
              ...
              <div className="flex items-center gap-2 text-gray-200 text-sm">
                <span className="bg-gray-400 py-1 px-4 rounded-full">
                  Mobile app
                </span>
                <span className="bg-gray-400 px-4 rounded-full">
                  Branding
                </span>
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-8">
          <div>
            ...
            <div className="bg-gray-900 text-gray-300 p-8 rounded-xl shadow-2xl flex items-center justify-between flex-wrap xl:flex-nowrap gap-8">
              <div>
              ...
              <div className="w-full xl:w-auto">
                <button className="bg-gray-800 py-2 px-6 rounded-xl text-white w-full">
                  Join now
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-2xl mb-8 flex flex-col gap-8">
              <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                ...
                <div>
                  <span className="bg-gray-400 py-2 px-4 rounded-full text-white">
                    Design
                  </span>
                </div>
              </div>
              ...
              <div className="bg-gray-400 flex flex-col md:flex-row items-center justify-between gap-4 py-8 px-4 rounded-lg">
                <div>
                  <sup className="text-sm text-gray-900">&euro;</sup>{" "}
