...
export const ShoppingCart = () => {
  ...
  return (
    <div className=" bg-gray-100 pt-20">
      <h1 className="mb-10 text-center text-2xl font-bold text-[#101110]">Shopping Cart</h1>
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            >
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  <h2 className="text-lg font-bold text-gray-900">nombre{product.title}</h2>
                  <p className="mt-1 text-xs text-gray-700">desc{product.description}</p>
                </div>
        ...
        <div className="flex justify-between">
          ...
          <div className="">
            <p className="mb-1 text-lg font-bold">$100 USD</p>
